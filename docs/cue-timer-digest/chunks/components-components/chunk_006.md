# Chunk 6: components_components

## Metadata

- **Files**: 1
- **Size**: 16,073 characters (~4,018 tokens)
- **Categories**: components

## Files in this chunk

- `components/blog/BlogContentEnhanced.tsx`

---

## File: `components/blog/BlogContentEnhanced.tsx`
            ...
            <div className='flex items-start justify-between'>
              <div className='flex items-center gap-2'>
                {templateConfig && TemplateIcon && (
                  <div
                    className={`p-1 rounded ${templateConfig.color} bg-opacity-10`}
                  >
      ...
      <CardHeader className='pb-3'>
        ...
        <div className='flex items-start justify-between'>
          <div className='flex items-center gap-3'>
            {templateConfig && TemplateIcon && (
              <div
                className={`p-2 rounded-lg ${templateConfig.color} bg-opacity-10`}
              >
          ...
          {showMetrics && (
            <div className='flex items-center gap-2 text-sm text-muted-foreground'>
              ...
              {post.seoScore && (
                <Badge
                  variant={post.seoScore >= 80 ? 'default' : 'secondary'}
                  className='text-xs'
                >
                  SEO: {post.seoScore}
                </Badge>
