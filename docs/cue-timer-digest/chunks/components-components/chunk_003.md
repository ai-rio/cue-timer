# Chunk 3: components_components

## Metadata

- **Files**: 1
- **Size**: 21,343 characters (~5,335 tokens)
...
## File: `components/blog/AccessibleBlogSearch.tsx`
    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className='relative'>
        ...
        <div id='search-instructions' className='sr-only'>
          Type to search blog posts by title, content, author, or tags. Results
            ...
            {DIFFICULTY_OPTIONS.map((option) => (
              ...
              >
                <div className='flex items-center gap-2'>
                  ...
                  <div
                    id={`difficulty-desc-${option.value}`}
                    className='sr-only'
                  >
                    {option.description}
                  </div>
            ...
            {SORT_OPTIONS.map((option) => (
              ...
              >
                <div>
                  ...
                  <div
                    id={`sort-desc-${option.value}-desc`}
                    className='sr-only'
                  >
                    {option.description}
                  </div>
