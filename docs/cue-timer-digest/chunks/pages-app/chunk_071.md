...
- **Files**: 1
- **Size**: 32,082 characters (~8,020 tokens)
- **Categories**: pages
...
## File: `app/[locale]/design-system/page.tsx`
      ...
      <div className='max-w-7xl mx-auto mb-8'>
        <div className='flex items-center justify-between mb-6'>
          <div>
            <h1 className='text-4xl font-bold tracking-tight mb-2'>
              CueTimer Design System
            </h1>
            <p className='text-lg text-muted-foreground'>
              Comprehensive component showcase using shadcn/ui with CueTimer
              brand styling
            </p>
          </div>
        ...
        <Card className='mb-8'>
          <CardHeader>
            ...
            <CardDescription>
              Primary and secondary brand colors following CueTimer design
              system
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <TabsContent value='typography' className='space-y-6'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Font hierarchy and usage following design system
                  specifications
                </CardDescription>
              </CardHeader>
                ...
                <div className='space-y-4'>
                  ...
                  <div>
                    ...
                    <p className='text-base leading-relaxed'>
                      This is body text using Inter Regular. It's optimized for
                      readability and follows the mobile-first approach with
              ...
              <Card>
                ...
                <CardContent className='space-y-4'>
                  <div className='space-y-2'>
                    ...
                    <Input
                      id='timer-name'
                      placeholder='Main Presentation Timer'
                    />
                  </div>
          ...
          <TabsContent value='timer' className='space-y-6'>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Mobile-first timer interface simulation
                </CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardContent className='space-y-6'>
                ...
                <div>
                  ...
                  <div className='flex flex-wrap gap-4'>
                    <Badge
                      variant='outline'
                      className='text-success-green border-success-green'
                    >
                    ...
                    <Badge
                      variant='outline'
                      className='text-warning-red border-warning-red'
                    >
                        ...
                        <CardContent className='p-4 text-center'>
                          <div
                            ...
                            style={{
                              color: '#FFFFFF',
                              fontFamily:
                                'var(--font-timer), Inter, sans-serif',
                              fontWeight: 700,
          ...
          <TabsContent value='overlay' className='space-y-6'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Modals, tooltips, and overlay interfaces
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className='flex flex-wrap gap-4'>
                          ...
                          <CardContent className='p-4 text-center'>
                            <div
                              ...
                              style={{
                                ...
                                border:
                                  '1px solid hsla(var(--foreground), 0.2)',
                                display: 'inline-block',
                              }}
                            >
                              0{item}:00
