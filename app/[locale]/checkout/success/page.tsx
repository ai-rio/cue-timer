    ...
    <div className='min-h-screen bg-gradient-to-b from-green-50 to-white'>
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 py-20'>
        <div className='max-w-2xl mx-auto text-center'>
          ...
          {/* Success Message */}
          <h1 className='text-4xl font-bold text-gray-900 mb-4'>Welcome to CueTimer Pro!</h1>
          <p className='text-xl text-gray-600 mb-8'>
            Your subscription has been activated successfully. You're all set to take your event
              ...
              <CardContent>
                <div className='space-y-4 text-left'>
                  <div className='flex justify-between'>
                    ...
                    <span className='font-medium'>CueTimer {sessionData.plan}</span>
                  </div>
                  <div className='flex justify-between'>
                ...
                <div className='flex items-start gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600 text-sm'>
                      We've sent a confirmation email with your receipt and getting started guide.
                    </p>
                  </div>
                </div>
                <div className='flex items-start gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600 text-sm'>
                      Start using unlimited timers, presenter messaging, and all Pro features.
                    </p>
                  </div>
                </div>
                <div className='flex items-start gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600 text-sm'>
                      Add team members to collaborate on timing and presenter management.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            <Button size='lg' className='bg-brand-orange hover:bg-brand-600 text-white' asChild>
          ...
          <div className='mt-12 p-6 bg-gray-50 rounded-lg'>
            ...
            <p className='text-gray-600 mb-4'>
              Our support team is here to help you get the most out of CueTimer Pro.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
