...
export default function BlogGrid({
  ...
  if (posts.length === 0 && featured.length === 0) {
    return (
      <div className='text-center py-12'>
        ...
        <h3 className='text-lg font-semibold text-gray-900 mb-2'>{t('emptyStates.noPosts')}</h3>
  ...
  return (
    <div className='space-y-12'>
      ...
      {featured.length > 0 && (
        <div>
          <h2 className='text-2xl font-bold text-gray-900 mb-6'>{t('featuredPosts')}</h2>
      ...
      {posts.length > 0 && (
        <div>
          {featured.length > 0 && (
            <h2 className='text-2xl font-bold text-gray-900 mb-6'>{t('totalPosts')}</h2>
          )}
          <div className='grid gap-8 md:grid-cols-2 lg:grid-cols-3'>
            {posts.map((post) => (
