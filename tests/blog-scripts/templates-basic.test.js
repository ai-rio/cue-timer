...
const mockTimingGuideTemplate = {
  ...
  variables: [
    ...
    { name: 'difficulty', type: 'string', required: false, defaultValue: 'beginner' },
    { name: 'estimatedTime', type: 'string', required: false, defaultValue: '10 minutes' },
  ],
  contentStructure: [
...
function runTests() {
  ...
  test('Feature Announcement Template has correct structure', () => {
    ...
    expect(mockFeatureAnnounceTemplate.name).toBe('Feature Announcement Template');
  ...
  test('Presentation Tips Template has correct structure', () => {
    ...
    expect(mockPresentationTipsTemplate.name).toBe('Presentation Tips Template');
  ...
  test('Generates case study content', () => {
    const variables = {
      ...
      results: [{ metric: 'Efficiency', value: '+40%', description: 'Improved efficiency' }],
    };
  ...
  test('Generates presentation tips content', () => {
    const variables = {
      ...
      tips: [
        ...
        { title: 'Eye Contact', description: 'Maintain eye contact', category: 'delivery' },
      ],
    };
  ...
  test('Handles complex nested data', () => {
    const variables = {
      ...
      results: [
        ...
        { metric: 'Efficiency', value: '+85%', description: 'Operational efficiency' },
        { metric: 'Satisfaction', value: '4.9/5', description: 'Customer satisfaction score' },
      ],
    };
